 ...
 * the License.
 */
package com.example.ocenastylujazdy.BluetoothELM327.OBD.commands;
...
public class ObdMultiCommand {
    ...
    private ArrayList<com.github.pires.obd.commands.ObdCommand> commands;
     ...
     */
    public void add(com.github.pires.obd.commands.ObdCommand command) {
     ...
     * @param command a {@link com.github.pires.obd.commands.ObdCommand} object.
     */
    public void remove(com.github.pires.obd.commands.ObdCommand command) {
    ...
    public void sendCommands(InputStream in, OutputStream out)
        ...
        for (com.github.pires.obd.commands.ObdCommand command : commands)
            command.run(in, out);
    }
